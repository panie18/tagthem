import React, { useState, Children, useRef, useLayoutEffect, FC, ReactNode, HTMLProps } from 'react';
import { motion, AnimatePresence } from 'framer-motion';

import './Stepper.css';

interface StepperProps extends Omit<HTMLProps<HTMLDivElement>, 'children'> {
  children: ReactNode;
  initialStep?: number;
